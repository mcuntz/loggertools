...
# -*- coding: utf-8 -*-
#
# loggertools documentation build configuration file, created by
...
import os
import sys
# this line is needed, if loggertools is not installed yet
sys.path.insert(
    0, os.path.dirname(os.path.abspath(__file__)) + '/../../src')
from loggertools import __version__ as ver
...
project = "loggertools"
copyright = ("2014-{}, Matthias Cuntz, Olaf Kolle".format(curr_year))
...
html_theme_options = {
    'description': ('Python port of the Control File Functions of Logtools,'
                    ' the Logger Tools Software of Olaf Kolle, MPI-BGC Jena,'
                    ' (c) 2012.'),
    'extra_nav_links': {
...
htmlhelp_basename = "loggertoolsdoc"
...
man_pages = [
    (master_doc, "loggertools", "Documentation of loggertools", [author], 1)
]
